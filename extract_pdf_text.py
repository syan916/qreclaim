...
def main():
    ...
    pdf_path = r"c:\Users\songy\Desktop\Qreclaim_LNF_System\RSDY3S1_LSY_Project I Report.pdf"
    
    # Output path for extracted text
    output_path = r"c:\Users\songy\Desktop\Qreclaim_LNF_System\fyp_report_extracted.txt"
